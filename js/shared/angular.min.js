      ...
      function (a, b, c, q, N, n, v, w, O, E, H) {
        ...
        function C(a, b, c, d, e) {
          ...
          r(a, function (b, c) {
            b.nodeType == mb &&
              b.nodeValue.match(/\S+/) &&
              (a[c] = B(b).wrap("<span></span>").parent()[0]);
          });
              ...
              for (
                ...
                a: {
                  ...
                  if (d.hasOwnProperty(C)) {
                    E = void 0;
                    for (
                      var C = a.get(C + "Directive"), W = 0, r = C.length;
                      W < r;
                      W++
                    )
        ...
        function aa(a, d, e, f, g, k, l, q, p) {
          ...
          for (
            var v = -Number.MAX_VALUE,
              ...
              x = !1,
              Na = !1,
              D = p.hasElementTranscludeDirective,
              T = (e.$$element = B(d)),
              J,
              ga,
              A,
            ...
            if (J.template)
              if (
                ...
                ya("template", aa, J, T),
                (aa = J),
                (A = F(J.template) ? J.template(T, e) : J.template),
                (A = Pc(A)),
                J.replace)
              ) {
                k = J;
            ...
            if (J.templateUrl)
              (Na = !0),
                ...
                (aa = J),
                J.replace && (k = J),
                (H = G(a.splice(R, a.length - R), T, e, g, x && Ga, l, q, {
              ...
              try {
                (za = J.compile(T, e, Ga)),
                  F(za) ? w(null, za, zb, $) : za && w(za.pre, za.post, zb, $);
              } catch (ca) {
                c(ca, va(T));
              }
    ...
    this.$get = [
      ...
      function (d, e) {
        ...
        return function (g, h, k, l) {
          ...
          if (k)
            return (
              (k = (y(g) ? g[g.length - 1] : g).prototype),
              (m = Object.create(k)),
              s && f(h, s, m, p || g.name),
              D(
                function () {
        ...
        function m(c, f, k) {
          ...
          if (M)
            if (((C = M.get(r)), z(C))) {
              ...
              y(C) ? w(C[1], C[0], ua(C[2]), C[3]) : w(C, 200, {}, "OK");
            } else M.put(r, H);
          G(C) &&
            ((C = Wc(c.url)
              ? e.cookies()[c.xsrfCookieName || b.xsrfCookieName]
              : u) && (k[c.xsrfHeaderName || b.xsrfHeaderName] = C),
            d(
              c.method,
              r,
              f,
    ...
    this.$get = [
      ...
      function (c, d, e) {
        ...
        function g(f, g, t, q) {
          ...
          q = !!q;
          for (
            var v, w, O = 0, E = [], H = [], M = f.length, C = [], r = [];
            O < M;

          )
            if (-1 != (v = f.indexOf(b, O)) && -1 != (w = f.indexOf(a, v + h)))
              O !== v && C.push(N(f.substring(O, v))),
                (O = f.substring(v + h, w)),
                E.push(O),
                H.push(c(O, n)),
                (O = w + k),
  ...
  r(
    {
      ...
      isolateScope: function (b) {
        return (
          B.data(b, "$isolateScope") || B.data(b, "$isolateScopeNoTemplate")
        );
      },
      controller: Gc,
      injector: function (b) {
            ...
            return function (a, f, g, l, m) {
              ...
              a.$watchCollection(p, function (g) {
                ...
                if (Ra(g)) (y = g), (n = v || w);
                  ...
                  y = [];
                  for (I in g)
                    g.hasOwnProperty(I) && "$" != I.charAt(0) && y.push(I);
                  y.sort();
                }
                D = y.length;
                I = Array(D);
                ...
                for (l = 0; l < D; l++)
                  if (
                    ((x = g === y ? l : y[l]), (G = g[x]), (F = I[l]), F.scope)
                  ) {
                    C = p;
                    do C = C.nextSibling;
                    while (C && C.$$NG_REMOVED);
